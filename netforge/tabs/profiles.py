...
# BGP sub-editor lives in its own module; re-export the parse helpers so
# existing importers (and tests) keep finding them on this module.
from netforge.tabs.profiles_bgp import (  # noqa: F401
    BgpEditorMixin,
...
class ProfilesTab(BgpEditorMixin, ttk.Frame):
